...
sender = '1969582484@qq.com'  # 发件人邮箱账号
my_pass = 'dlmuhszavbulcbif'  # 发件人邮箱授权码
user = '1969582484@qq.com'  # 收件人邮箱账号
...
att = MIMEApplication(open('TEST1.html', 'rb').read(), 'base64')  # 构造附件，三个参数：第一个为附件路径，第二个附件格式，第三个附件设置编码utf-8
